...
public class GameApiService
{
    ...
    private const string BASE_URL = "https://68f95ab1deff18f212b951b3.mockapi.io";
    ...
    public async Task<Jogador[]> GetTodosJogadores()
    {
        try
        {
            string url = $"{BASE_URL}/usuariojogo";
            Debug.Log($"GET: {url}");
    ...
    public async Task<Jogador> GetJogador(string id)
    {
        try
        {
            string url = $"{BASE_URL}/usuariojogo/{id}";
            Debug.Log($"GET: {url}");
    ...
    /// </summary>
    public async Task<ItemJogador[]> GetItensJogador(int jogadorId)
    {
        try
        {
            string url = $"{BASE_URL}/usuariojogo/{jogadorId}/Item";
            Debug.Log($"GET: {url}");
            ...
            string wrappedJson = $"{{\"Item\":{json}}}"; //itens
    ...
    public async Task<ItemJogador> GetItem(string jogadorId, string itemId)
    {
        try
        {
            string url = $"{BASE_URL}/usuariojogo/{jogadorId}/Item/{itemId}";
            Debug.Log($"GET: {url}");
